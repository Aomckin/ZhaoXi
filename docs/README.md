...
- [Phase 2 开发报告](Zhaoxi_v1.2.0_Phase2_Release_Notes.md)：场景构图、角色锚点、响应式、前后截图及原生标题栏保留说明。
...
- [`Zhaoxi_v1.1.7_Release_Notes.md`](v1.1.x/Zhaoxi_v1.1.7_Release_Notes.md)：ACTIVE Beat、会话预算与验证状态。

- [`Zhaoxi_v1.1.6.1_Release_Notes.md`](v1.1.x/Zhaoxi_v1.1.6.1_Release_Notes.md)：普通聊天桌面上下文注入补丁。
...
- [Phase 2 Scene Composition](Zhaoxi_v1.2.0_Visual_Refresh_Phase2_Scene_Composition_Task.md)：Phase 2 场景构图任务书。

- [v1.2.0 Visual Refresh](Zhaoxi_v1.2.0_Visual_Refresh_Phase1_Development_Task.md)：Phase 1 视觉焕新任务书。

- [`Zhaoxi_v1.1.8_Dynamic_ToolProvider_MCP_Development_Task.md`](v1.1.x/Zhaoxi_v1.1.8_Dynamic_ToolProvider_MCP_Development_Task.md)：协议无关 Provider 扩展与 MCP Tool 动态注册任务书。

- [`Zhaoxi_v1.1.7_Active_Conversation_Closure_Development_Task.md`](v1.1.x/Zhaoxi_v1.1.7_Active_Conversation_Closure_Development_Task.md)：v1.1.x 对话闭环收尾任务书。

- [`Zhaoxi_v1.1.6.1_Desktop_Context_Injection_Patch.md`](v1.1.x/Zhaoxi_v1.1.6.1_Desktop_Context_Injection_Patch.md)：普通对话 Runtime 注入任务书。
...
以下文件描述 v1.0 历史基线，内容必须与代码、测试和产物同步：

- [`CODEBASE_STATUS.md`](CODEBASE_STATUS.md)：当前能力、限制、测试数和 Git 基线的首要事实源。
- [`Zhaoxi_v1.0_Release_Notes.md`](Zhaoxi_v1.0_Release_Notes.md)：用户可见能力、数据策略和已知限制。
- [`Zhaoxi_v1.0_Operations_Runbook.md`](Zhaoxi_v1.0_Operations_Runbook.md)：安装、诊断、备份、恢复与故障处理。
- [`Zhaoxi_v1.0_Release_Checklist.md`](Zhaoxi_v1.0_Release_Checklist.md)：正式版完成项。
- [`Zhaoxi_v1.0_RC_Report.md`](Zhaoxi_v1.0_RC_Report.md)：环境、测试、soak、产物和未实测项证据。
- [`Zhaoxi_v1.0_Release_Development_Task.md`](Zhaoxi_v1.0_Release_Development_Task.md)：正式版范围与验收标准。
- [`Zhaoxi_v1.0_Prerequisite_LifeHUD_Tool_Decoupling_Task.md`](Zhaoxi_v1.0_Prerequisite_LifeHUD_Tool_Decoupling_Task.md)：LifeHUD-Tool 解耦边界与完成证据。
